    ...
    <div class="container">
        <div class="row">
            <form action="process.php" method="POST">
                    <input type="number" name="number1" placeholder="broj">
                    <span>+</span>
                    <input type="number" name="number2" placeholder="broj">
                    <br>
                    <input type="number" name="number3" placeholder="broj">
                    <span>-</span>
                    <input type="number" name="number4" placeholder="broj">
                    <br>
                    <input type="number" name="number5" placeholder="broj">
                    <span>*</span>
                    <input type="number" name="number6" placeholder="broj">
                    <br>
                    <input type="number" name="number7" placeholder="broj">
                    <span>/</span>
                    <input type="number" name="number8" placeholder="broj">
                    <br>
